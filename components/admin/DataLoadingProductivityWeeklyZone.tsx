...
interface DataLoadingProductivityWeeklyZoneProps {
...
const DataLoadingProductivityWeeklyZone: React.FC<DataLoadingProductivityWeeklyZoneProps> = ({ setView }) => {
  ...
  const handleExport = () => {
    ...
    link.download = 'produtividade_semanal_zona_export.txt';
    link.click();
  ...
  return (
    <div className="w-full max-w-5xl bg-white p-8 rounded-xl shadow-lg space-y-6">
      <div className="flex justify-between items-center">
        <div>
            <h1 className="text-2xl font-bold text-gray-800">Dados Semanais Zona - Produtividade</h1>
...
export default DataLoadingProductivityWeeklyZone;